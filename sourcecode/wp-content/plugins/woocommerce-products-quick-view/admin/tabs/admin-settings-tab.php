...
<?php
/*-----------------------------------------------------------------------------------
WC Quick View Admin Settings Tab
...
class WC_QV_Admin_Settings_Tab extends WC_QV_Admin_UI
{	
	/**
	 * @var string
	 */
...
$wc_qv_admin_settings_tab = new WC_QV_Admin_Settings_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_qv_admin_settings_tab_manager() {
	global $wc_qv_admin_settings_tab;
	$wc_qv_admin_settings_tab->tab_manager();
}
