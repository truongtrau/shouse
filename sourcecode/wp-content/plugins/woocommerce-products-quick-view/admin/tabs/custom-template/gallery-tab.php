...
<?php
/*-----------------------------------------------------------------------------------
WC Quick View Custom Template Gallery Tab
...
class WC_QV_Custom_Template_Gallery_Tab extends WC_QV_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/custom-template/gallery-style-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/custom-template/gallery-icon-styles-settings.php' );
	}
...
global $wc_qv_custom_template_gallery_tab;
$wc_qv_custom_template_gallery_tab = new WC_QV_Custom_Template_Gallery_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_qv_custom_template_gallery_tab_manager() {
	global $wc_qv_custom_template_gallery_tab;
	$wc_qv_custom_template_gallery_tab->tab_manager();
}
