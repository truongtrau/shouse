...
class WC_QV_Admin_UI
{
	...
	public $toggle_box_open_option = WC_QUICK_VIEW_ULTIMATE_KEY . '_toggle_box_open';
	public $version_transient      = WC_QUICK_VIEW_ULTIMATE_KEY . '_licinfo';
	 ...
	 */
	public $pro_plugin_page_url = 'https://a3rev.com/shop/woocommerce-quick-view-ultimate/';
		...
		if ( false !== $version_transient ) {
			...
			if ( false === $timeout ) {
				...
				if ( FALSE !== stristr( $version_transient, '||' )
					...
					&& version_compare( WC_QUICK_VIEW_ULTIMATE_VERSION , $version_info[0], '<' ) ) {
