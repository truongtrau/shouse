...
define( 'NOTIFIER_THEME_NAME', 'WooShop Lite' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wooshoplite' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://dessky.com/notifiers/wooshoplite-notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier() { 
	...
	<div class="wrap">
		...
		<div id="instructions">
		    ...
		    <p>To update the Theme, login to <a href="http://www.dessky.com/">Dessky</a>, head over to the <strong>Themes</strong> section and re-download the theme like you did when you bought it.</p>
